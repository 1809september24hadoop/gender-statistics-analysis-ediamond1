...
public class USEmploymentMapperM extends Mapper<LongWritable, Text, Text, DoubleWritable>{		//generics are input K/V, output K/V, will depend on the actual task
	...
	public void map(LongWritable key, Text value, Context context)  				//context abstracts where we're writing
		...
		if (parsedLines[1].equals("USA") && parsedLines[3].equals("SL.EMP.TOTL.SP.MA.NE.ZS")){		
