...
/**
 * Filters the Data to find worldwide employment to population ratio, female
 * Writes all numerical data since the year 2000
 */
public class EmploymentMapperF extends Mapper<LongWritable, Text, Text, DoubleWritable>{		
	...
	public void map(LongWritable key, Text value, Context context)  				
		...
		if (parsedLines[1].equals("WLD") && parsedLines[3].equals("SL.EMP.TOTL.SP.FE.ZS")){		
